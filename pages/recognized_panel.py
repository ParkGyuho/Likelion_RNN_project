    ...
    try:
        ...
        for i, matched_chars in enumerate(matched_result):
            ...
            rotation_matrix = cv2.getRotationMatrix2D(
                center=(plate_cx, plate_cy), angle=angle, scale=1.2)
        ...
        for i, plate_img in enumerate(plate_imgs):
            ...
            pytesseract.pytesseract.tesseract_cmd = 'C:/Users/pgho8/Likelion_AI6/tees_OCR/tesseract.exe'
